...
public class SkywarsGame extends Game {
	...
	public boolean processPlayerTab(NetworkPlayerInfo player, TabOverlay tabOverlay) {
        ...
        tabOverlay.setFooter(new ChatComponentText(ChatFormatting.GREEN + "Displaying " + ChatFormatting.RED + "Skywars K/D" + ChatFormatting.GREEN + " in tab"));
        ...
        String kdr = playerRequest==null?"?":playerRequest.getSkywarsKDRStr();
